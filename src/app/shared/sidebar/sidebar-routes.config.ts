...
export const ROUTES: RouteInfo[] = [
    ...
    // },
        ...
        { path: '/services', title: 'Workshops', icon: 'ft-life-buoy', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        { path: '/smells', title: 'Articles', icon: 'ft-cloud', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        // { path: '/items', title: 'Subcategories', icon: 'ft-tag', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    ...
    // },
    // {
    //     path: '', title: 'Payments', icon: 'ft-tag', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
